# Pomo+doro
`Pomo+doro` is a back end of RESTful [rocket](https://github.com/SergioBenitez/Rocket) server for [`pomodoro technique`](https://en.wikipedia.org/wiki/Pomodoro_Technique), which is currently a project for personal rust programming practice. To get more information about the design, please check the wiki(currently not available).
